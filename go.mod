module github.com/kubeapps/oauth2-bitnami
...
require (
	...
	golang.org/x/crypto v0.0.0-20171124090802-b080dc9a8c48 // indirect
	golang.org/x/net v0.0.0-20171123081856-c7086645de24 // indirect
	golang.org/x/oauth2 v0.0.0-20171117235251-f95fa95eaa93
	golang.org/x/sys v0.0.0-20171123182949-a13efeb2fd21 // indirect
